...
class PIC
{
 public:
    ...
    /*________IO PORTS___________________________________________________________*/
    ...
    /*________INITIALIZATION COMMAND WORDS_______________________________________*/
    ...
    // ICW2: Vector offset remapping. The value specified here is added to each IRQ
    ...
    /*________OUTPUT COMMAND WORDS_______________________________________________*/
    ...
    /*________INTERRUPT REQUEST LINES____________________________________________*/
