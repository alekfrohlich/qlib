...
/*________ CONTROL OVERLOADS _______________________________________________ */
...
/*________ DATA OVERLOADS __________________________________________________ */
...
OStream &OStream::operator<<(long l) { return operator<<(static_cast<int>(l)); }
...
/*________ CONVERSION FUNCTIONS ____________________________________________ */
